    ...
    <>
      ...
      >
        ...
        {!edition ? (
          <div>
            <div>
              <Typography variant="h2">{estate_name}</Typography>
            </div>
            <div>
              <Typography variant="h2">{vintage}</Typography>
            </div>
            <div>
              <Typography variant="h2">{appellation}</Typography>
            </div>
            <div>
              <Typography variant="h2">{type}</Typography>
            </div>
            <div>
              <Typography variant="h2">{grape}</Typography>
            </div>
            <div>
              <Typography variant="h2">{organic}</Typography>
            </div>
            <div>
              <Typography variant="h2">{price}</Typography>
            </div>
            <div>
              <Typography variant="h2">{buying_year}</Typography>
            </div>
            <div>
              <Typography variant="h2">{quantity}</Typography>
            </div>
            <div>
              <Typography variant="h2">{tasting_note}</Typography>
            </div>
            <div>
